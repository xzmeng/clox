...
static void emitLoop(int loopStart)
{
    ...
    // 2 offset for the operand of OP_LOOP itself
...
{
    // -2 to ajust for the bytecode for the jump offset itself
...
static void function(FunctionType type)
{
    ...
    // The body
    consume(TOKEN_LEFT_BRACE, "Expect '{' before function");
    block();
